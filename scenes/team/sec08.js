...
const T = {
  ...
  line1Out: 66.80,   // just before the dashboard rises
  ...
  shrink:   999.00,   // "establish measurable"              -> dashboard shrinks and rises
  optA:     999.00,   // "Maybe that's a common standard"    -> option card A
  optB:     999.00,   // "Maybe each team has its own SLA"   -> option card B
  check:    999.00,   // "either approach"                   -> a check on BOTH at once
  back:     999.00,   // "The important part"                -> dashboard returns behind
  line2:    999.00,   // "actually see the results"          -> on-screen line
};
