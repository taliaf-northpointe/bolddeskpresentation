...
const T = {
  noraIn:   0.19,
  row:     16.15,   // cue "And a better experience for the people asking for help, ..."
  fifth:   16.42,   // word "experience" (first time)
  signoff: 39.20,   // just ahead of cue "I'm Nora." (39.74)
  endcard: 44.52,   // cue end of "And I'll see you at the help desk!" — her last word
};

/* The four punch lines: each chip lands exactly at its cue start. */
const PUNCH = [
  { t:  7.00, text: 'Better tracking' },
  { t:  8.67, text: 'Better communication' },
  { t: 10.66, text: 'More visibility' },
  { t: 14.34, text: 'More automation' },
];

/* Blinks in the silences between phrases. */
const BLINKS = [
  3.75,    // "...across Northpointe," (3.64) -> "but" (4.00)
  6.57,    // "...pretty exciting." (6.21) -> 7.00
  8.35,    // "Better tracking." (8.07) -> 8.67
  13.02,   // "More visibility." (11.86) -> 14.34
  15.82,   // "More automation." (15.55) -> 16.15
  17.42,   // "...asking for help," (17.37) -> "which" (17.50)
  28.59,   // "...here to serve." (19.15) -> 39.74
  40.97,   // "I'm Nora." (40.62) -> 41.32
  42.63,   // "Thanks for listening." (42.38) -> 42.88
];
