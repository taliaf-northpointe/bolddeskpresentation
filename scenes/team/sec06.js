...
const T = {
  ...
  formA:    40.23,   //                                -> the form in the upper lane
  fieldsA:  40.76,   //                                -> its three fields, .38 apart
  badge:    41.03,   // "30 seconds" (40.94)          -> "+30 s"
  fastGo:   43.72,   // "give us the information we need" -> the detailed request moves
  fastDone: 49.57,   // "save" (49.53)                -> and reaches the green check
  slowGo:   46.66,   // "But that small amount of effort" -> the vague one crawls
  notes:    46.66,   //                                -> five emails, .8 apart
  slowDone: 57.57,   // "the request worked"          -> the vague one finally lands
  line:     51.53,   // "much more time later"        -> on-screen line
};
