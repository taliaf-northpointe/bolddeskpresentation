...
const T = {
  ...
  mailIn:   5.59,   // "moving emails" (5.75)          -> two envelopes on the path
  mailOut:  7.29,   // "another"                       -> and they fade
  lines: [
    8.29,           // "It's about making it easier for people to get help."
    26.57,          // "And ultimately, it's about helping the people who serve our customers..."
  ],
  shift:    32.77,  // "Because whether"               -> list clears, path slides left
  cards: [
    34.68,          // "borrower"
    36.01,          // "business partner"
    37.87,          // "retail customer"
    40.37,          // "Northpointe employee"
  ],
  line:     42.78,  // "we all play a part" (42.96)    -> the closing line, all else recedes
};
