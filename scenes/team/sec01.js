...
const T = {
  platform: 11.40,   // word "platform" in "...working on building a great platform..."
  bubble:   14.40,   // cue "The platform is an Enterprise Support Portal."
  one:      26.46,   // word "One" in "The idea is One Northpointe Support Experience."
  email:    31.62,   // word "email" in "an email sent to a support team becomes a ticket"
  ticket:   33.66,   // word "ticket"
  agent:    36.45,   // word "agent" in "The team member working that ticket is the agent"
  trial:    999.00,   // cue "Right now, we're trialing an application called BoldDesk, ..."
  bolddesk: 999.00,   // word "BoldDesk"
  lift:     999.00,   // breath before "A handful of teams..." — bubble lifts, grid arrives
  handful:  999.00,   // cue "A handful of teams have already started testing it."
  testing:  999.00,   // word "testing" — the handful light up
  every:    999.00,   // word "every" in "...if every team was on it?" — all light up
  onestop:  999.00,   // word "one-stop" — the chip lands
};
...
const BLINKS = [
  ...
  8.73,    // "...nice to meet you!" (8.20) -> 9.41
  19.38,   // "...across Northpointe." (18.84) -> 20.05
  24.67,   // "...Support Portal." (24.04) -> 25.40
  28.79,   // "...Support Experience." (28.77) -> 28.82
  29.15,   // breath inside the long line
  34.55,   // "...for our customers." (29.52) -> 40.33
  47.56,   // "...for Northpointe." (47.16) -> 47.96
  51.02,   // "...testing it." (50.74) -> 51.34
  55.61,   // "...was on it?" (55.30) -> 55.90
  62.52,   // after the last word
];
...
export function build(container) {
  ...
  label = node('div', { text: 'BoldDesk', style: {
  ...
  node('div', { text: 'BOLDDESK', style: {
    fontSize: '21px', letterSpacing: '.16em', color: BLUE,
    fontWeight: 700, marginBottom: '16px',
  }}, bubble);
  node('div', { html: 'A support platform for&nbsp;teams', style: {
