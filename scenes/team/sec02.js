...
const T = {
  cardHold:  0.74,     // "So, why BoldDesk?" ends 0.73 — card recedes right after
  clutterIn: 0.90,    // "Many ticketing systems are designed primarily..." 0.90
  cleanIn:   6.10,    // "BoldDesk is simple, clean, and user-friendly..." 6.10
  approach:  6.10,    // the clean card comes forward as the clutter recedes
  simple:    6.88,    // word "simple" 6.89
  figures:   10.50,   // "...easy for employees of all technical skill levels..." 10.50
  checkL:    10.50,   // word "employees" 10.51
  checkR:    12.35,   // word "levels" 12.35
  matters:   8.43,   // word "user-friendly" 8.43 — on-screen line
  line:      8.43,
};
