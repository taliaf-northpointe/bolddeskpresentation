...
const T = {
  ...
  tagPulse: 16.56,   // "future possibility"    -> the tag pulses once
  shield:   18.05,   // "approval"              -> shield + "AI Use Case Review Committee"
  govern:   19.98,   // "Committee"             -> "Approval first"
  step:     24.33,   // "We're not just looking at…" -> the card rises, the rest steps aside
  today:    25.59,   // "platform"              -> three small cards line up
  todayLab: 26.46,   // "today"                 -> the "Today" label
  join:     27.42,   // "We're looking at what it could grow into." -> summary joins the line
  outlines: 28.11,   //                          -> two faint empty outlines
  line:     28.36,   // "grow into"             -> "Room to grow."
};
...
export function build(container) {
  ...
  chipSec = chip(shieldRow, 'Northpointe approval', 'open', 22);
