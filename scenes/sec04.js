...
const T = {
  ...
  figIn:     3.1,    // the one figure, centre
  ring:      4.22,   // "Every one of us"              -> the soft ring
  ringPulse: 5.47,   // "customer"                     -> ring breathes once
  spread:    7.0,    // just before "That might be"    -> figure moves up, room for the row
  cards: [
  ...
  part1Out:  27.9,   // idea recedes before "Imagine"
  panelsIn:  28.4,   // split screen opens
  empIn:     28.9,   // "someone"                      -> employee at a laptop
  ...
  clockIn:   34.6,   // clock appears with "If that request"
  ...
  bubblesOut: 46.7,  // exchange clears for the line
